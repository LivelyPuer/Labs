    ...
    case WM_PAINT:
        {
            ...
            switch (cur_image) {
            case 0:
                Image0(hdc, image0_x, image0_y, RGB(0, 0, 0));
                break;
            case 1:
                Image1(hdc, image0_x, image0_y, RGB(0, 0, 0));
                break;
            case 2:
                Image2(hdc, image0_x, image0_y, RGB(0, 0, 0));
                break;
            case 3:
                Image3(hdc, image0_x, image0_y, RGB(0, 0, 0));
                break;
            case 4:
                Image4(hdc, image0_x, image0_y, RGB(0, 0, 0));
                break;
            case 5:
                Image5(hdc, image0_x, image0_y, RGB(0, 0, 0));
                break;
            }
            // TODO: Add any drawing c
            // ode that uses hdc here...
            EndPaint(hWnd, &ps);
        }
        break;
    case WM_LBUTTONDOWN:

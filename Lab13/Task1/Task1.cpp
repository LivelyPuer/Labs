...
void PictureV(HDC hdc, int cx, int cy) {
    int x, y, i;
    x = cx + 30, y = cy + 30, i = 0;
    do {
...
void PictureH(HDC hdc, int cx, int cy) {
    int x, y, i;
    x = cx + 30, y = cy + 30, i = 0;
    do {
...
void PictureVH(HDC hdc, int cx, int cy) {
    int x, y, i, j;
    y = 30 + cy;
    i = 0;
    do {
    ...
    case WM_PAINT:
        {
            ...
            x = 0, y = 0;
            // task 1
            Image0(hdc, x + 40, y + 40, RGB(255, 0, 0));
            Image0(hdc, x + 140, y + 40, RGB(200, 0, 0));
            Image0(hdc, x + 240, y + 40, RGB(150, 0, 0));
            Image0(hdc, x + 240, y + 240, RGB(100, 0, 0));
            Image0(hdc, x + 40, y + 240, RGB(0, 0, 0));
